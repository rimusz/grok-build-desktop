...
| `~/Library/Application Support/GrokBuild/Secrets/cursor-api-key` (0600) | Cursor API key for the managed bridge (`CursorBridgeKeychain`; file only, no Keychain) |
